...
var jogadoresMasculinos = atletas.filter(function(atletas) {
    return atletas.elenco === "masculino";
});

var jogadoresFemininos = atletas.filter(function(atletas) {
    return atletas.elenco === "feminino";
});

var jogadoresTodos = atletas;